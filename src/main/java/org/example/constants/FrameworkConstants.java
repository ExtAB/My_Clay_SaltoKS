...
public final class FrameworkConstants {
  ...
  public static final String ANDROID_APK_PATH =
    PROJECT_PATH + File.separator + RESOURCES_PATH + File.separator + "app" + File.separator +
      "SALTO KS_8.7.2_Apkpure.apk";
  public static final String CONFIG_PROPERTIES_PATH =
    PROJECT_PATH + File.separator + RESOURCES_PATH + File.separator + "config" + File.separator + "config.properties";
  public static final String CONFIG_JSON_PATH =
    PROJECT_PATH + File.separator + RESOURCES_PATH + File.separator + "config" + File.separator + "config.json";
